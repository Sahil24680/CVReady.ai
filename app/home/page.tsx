            ...
            <div className="flex items-center">
              ...
              {[...Array(5)].map((_, i) => (
                <svg
                  key={i}
                  className={`w-3 h-3 ${
                    i < rating ? "text-[#60A5FA]" : "text-gray-200"
                  }`}
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
...
export default function HomePage() {
  ...
  const demo_vid_link = "https://www.loom.com/share/ff230261c9c74653bab7755c1c5c6dd7?sid=9165559e-5317-44f9-b245-c48165fed199"
  /* demo lines */
  const demoInsights = [
  ...
  return (
    <div className="w-full">
      {/* page fade-in */}
      <div
        className={`w-full bg-gradient-to-br from-white via-blue-50/20 to-white transition-all duration-700 ${
